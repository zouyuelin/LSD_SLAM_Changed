               ...
               semidense_mapper->previous_images = semidense_mapper->num_cameras_mapping_th/2+1+1;
                ...
                ////////////////////////////GET PHOTOMETRIC TERM_SD term_sd ///////////////////////////////////////
                    if (semidense_mapper->do_init_semi > 0.5 )
                    {
                        ...
                        //std::cout<<semidense_mapper->depth_map*0<<endl;
                        semidense_mapper->depth_map = cv::Mat::zeros(semidense_tracker->image_frame->cols,semidense_tracker->image_frame->rows,CV_32F);
